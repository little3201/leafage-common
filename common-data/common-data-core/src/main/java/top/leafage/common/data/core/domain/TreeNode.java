...
package top.leafage.common.data.core.domain;
...
public class TreeNode<T> {
     ...
     * @param id  a T object
     * @param <T> a T class
     * @return a {@link TreeNode.TreeNodeBuilder} object
     */
    ...
    /**
     * Getter for the field <code>superiorId</code>.
     *
     * @return a T object
     */
    ...
    public static final class TreeNodeBuilder<T> {
        ...
        /**
         * for the field <code>superiorId</code>.
         *
        ...
        /**
         * for the field <code>children</code>.
         *
